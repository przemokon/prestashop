...
class MProductCommentCriterion extends ObjectModel
{
	public	$id;
	...
	public static function getByProduct($id_product, $id_lang)
	{
		...
		$cache_id = 'MProductCommentCriterion::getByProduct_'.(int)$id_product.'-'.(int)$id_lang;
	...
	public static function getTypes()
	{
		...
		$module = new MProductComments();

		return array(
			1 => $module->l('Valid for the entire catalog', 'MProductCommentCriterion'),
			2 => $module->l('Restricted to some categories', 'MProductCommentCriterion'),
			3 => $module->l('Restricted to some products', 'MProductCommentCriterion')
		);
	}
}
