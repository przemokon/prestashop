...
class MProductComments extends Module
{
    ...
    {
        $this->name = 'mproductcomments';
        $this->tab = 'front_office_features';
        $this->version = '3.6.1';
        $this->author = 'PrestaShop modified by Mirjan24';
    ...
    public function install($keep = true)
    {
        ...
        if (parent::install() == false ||
            ...
            !Configuration::updateValue('M_PRODUCT_COMMENTS_COMMENTS_PER_PAGE', 5) ||
            !Configuration::updateValue('M_PRODUCT_COMMENTS_MINIMAL_TIME', 30) ||
            !Configuration::updateValue('M_PRODUCT_COMMENTS_ALLOW_GUESTS', 0) ||
            !Configuration::updateValue('M_PRODUCT_COMMENTS_MODERATE', 1)) {
            return false;
        }
    ...
    {
        if (!parent::uninstall() ||
            !Configuration::deleteByName('M_PRODUCT_COMMENTS_COMMENTS_PER_PAGE') ||
            !Configuration::deleteByName('M_PRODUCT_COMMENTS_MODERATE') ||
            !Configuration::deleteByName('M_PRODUCT_COMMENTS_ALLOW_GUESTS') ||
            !Configuration::deleteByName('M_PRODUCT_COMMENTS_MINIMAL_TIME') ||
    ...
    protected function _postProcess()
    {
        ...
        if (Tools::isSubmit('submitModerate')) {
            Configuration::updateValue('M_PRODUCT_COMMENTS_MODERATE', (int) Tools::getValue('M_PRODUCT_COMMENTS_MODERATE'));
            Configuration::updateValue('M_PRODUCT_COMMENTS_ALLOW_GUESTS', (int) Tools::getValue('M_PRODUCT_COMMENTS_ALLOW_GUESTS'));
            Configuration::updateValue('M_PRODUCT_COMMENTS_MINIMAL_TIME', (int) Tools::getValue('M_PRODUCT_COMMENTS_MINIMAL_TIME'));
            Configuration::updateValue('M_PRODUCT_COMMENTS_COMMENTS_PER_PAGE', (int) Tools::getValue('M_PRODUCT_COMMENTS_COMMENTS_PER_PAGE'));
            ...
            $comment = new MProductComment($id_product_comment);
            $comment->validate();
            MProductComment::deleteReports($id_product_comment);
        } elseif (Tools::isSubmit('deleteproductcomments')) {
            $id_product_comment = (int) Tools::getValue('id_product_comment');
            $comment = new MProductComment($id_product_comment);
            $comment->delete();
        } elseif (Tools::isSubmit('submitEditCriterion')) {
            $criterion = new MProductCommentCriterion((int) Tools::getValue('id_product_comment_criterion'));
            ...
            $productCommentCriterion = new MProductCommentCriterion((int) Tools::getValue('id_product_comment_criterion'));
        ...
        $this->_clearcache('mproductcomments_reviews.tpl');
    }

    public function getContent()
    {
        include_once dirname(__FILE__).'/MProductComment.php';
        include_once dirname(__FILE__).'/MProductCommentCriterion.php';
        ...
        $this->_setBaseUrl();
        $this->_productCommentsCriterionTypes = MProductCommentCriterion::getTypes();
    ...
    public function renderConfigForm()
    {
            ...
            'form' => array(
                ...
                'input' => array(
                    array(
                        ...
                        'name' => 'M_PRODUCT_COMMENTS_MODERATE',
                        'values' => array(
                                        array(
                                            'id' => 'active_on',
                                            'value' => 1,
                    ...
                    array(
                        ...
                        'name' => 'M_PRODUCT_COMMENTS_ALLOW_GUESTS',
                        'values' => array(
                                        array(
                                            'id' => 'active_on',
                                            'value' => 1,
                    ...
                    array(
                        ...
                        'name' => 'M_PRODUCT_COMMENTS_MINIMAL_TIME',
                        'class' => 'fixed-width-xs',
                        'suffix' => 'seconds',
                    ),
                    array(
                        'type' => 'text',
                        'label' => $this->l('Number of products peer page (pagination)'),
                        'name' => 'M_PRODUCT_COMMENTS_COMMENTS_PER_PAGE',
                        'class' => 'fixed-width-xs',
                    ),
                ),
            'submit' => array(
        ...
        $helper->submit_action = 'submitMProducCommentsConfiguration';
    ...
    public function renderModerateLists()
    {
        ...
        if (Configuration::get('M_PRODUCT_COMMENTS_MODERATE')) {
            $comments = MProductComment::getByValidate(0, false);
        ...
        $comments = MProductComment::getReportedComments();
    ...
    public function renderCriterionList()
    {
        ...
        $criterions = MProductCommentCriterion::getCriterions($this->context->language->id, false, false);
    ...
    public function renderCommentsList()
    {
        ...
        $comments = MProductComment::getByValidate(1, false);
        $moderate = Configuration::get('M_PRODUCT_COMMENTS_MODERATE');
        if (empty($moderate)) {
            $comments = array_merge($comments, MProductComment::getByValidate(0, false));
        }
    ...
    {
        return array(
            'M_PRODUCT_COMMENTS_MODERATE' => Tools::getValue('M_PRODUCT_COMMENTS_MODERATE', Configuration::get('M_PRODUCT_COMMENTS_MODERATE')),
            'M_PRODUCT_COMMENTS_ALLOW_GUESTS' => Tools::getValue('M_PRODUCT_COMMENTS_ALLOW_GUESTS', Configuration::get('M_PRODUCT_COMMENTS_ALLOW_GUESTS')),
            'M_PRODUCT_COMMENTS_MINIMAL_TIME' => Tools::getValue('M_PRODUCT_COMMENTS_MINIMAL_TIME', Configuration::get('M_PRODUCT_COMMENTS_MINIMAL_TIME')),
            'M_PRODUCT_COMMENTS_COMMENTS_PER_PAGE' => Tools::getValue('M_PRODUCT_COMMENTS_COMMENTS_PER_PAGE', Configuration::get('M_PRODUCT_COMMENTS_COMMENTS_PER_PAGE')),
        );
    }

    public function getCriterionFieldsValues($id = 0)
    {
        $criterion = new MProductCommentCriterion($id);
    ...
    {
        $types = MProductCommentCriterion::getTypes();
        $query = array();
        ...
        $criterion = new MProductCommentCriterion((int) $id_criterion);
            ...
            if (count($product_comments)) {
                ...
                if ($action == 'delete') {
                    foreach ($product_comments as $id_product_comment) {
                        ...
                        $comment = new MProductComment((int) $id_product_comment);
                        $comment->delete();
                        MProductComment::deleteGrades((int) $id_product_comment);
                    }
                }
            }
        }
    ...
    {
        require_once dirname(__FILE__).'/MProductComment.php';
        require_once dirname(__FILE__).'/MProductCommentCriterion.php';

        $average = MProductComment::getAverageGrade((int) Tools::getValue('id_product'));

        $this->context->smarty->assign(array(
                                            'allow_guests' => (int) Configuration::get('M_PRODUCT_COMMENTS_ALLOW_GUESTS'),
                                            'comments' => MProductComment::getByProduct((int) (Tools::getValue('id_product'))),
                                            'criterions' => MProductCommentCriterion::getByProduct((int) (Tools::getValue('id_product')), $this->context->language->id),
                                            'averageTotal' => round($average['grade']),
                                            'nbComments' => (int) (MProductComment::getCommentNumber((int) (Tools::getValue('id_product')))),
                                       ));
    ...
    public function hookDisplayProductListReviews($params)
    {
        ...
        if (!$this->isCached('mproductcomments_reviews.tpl', $this->getCacheId($id_product))) {
            require_once dirname(__FILE__).'/MProductComment.php';
            $average = MProductComment::getAverageGrade($id_product);
            $this->smarty->assign(array(
                'product' => $params['product'],
                'averageTotal' => round($average['grade']),
                'ratings' => MProductComment::getRatings($id_product),
                'nbComments' => (int) MProductComment::getCommentNumber($id_product),
            ));
        }

        return $this->display(__FILE__, 'views/templates/hook/mproductcomments_reviews.tpl', $this->getCacheId($id_product));
    }
    ...
    public function hookDisplayRightColumnProduct($params)
    {
        ...
        $customerComment = MProductComment::getByCustomer((int) (Tools::getValue('id_product')), (int) $this->context->cookie->id_customer, true, (int) $id_guest);
        ...
        $this->context->smarty->assign(array(
            ...
            'action_url' => '',
            'averageTotal' => round($average['grade']),
            'ratings' => MProductComment::getRatings((int) Tools::getValue('id_product')),
            'too_early' => ($customerComment && (strtotime($customerComment['date_add']) + Configuration::get('M_PRODUCT_COMMENTS_MINIMAL_TIME')) > time()),
            'nbComments' => (int) (MProductComment::getCommentNumber((int) Tools::getValue('id_product'))),
            'comments' => MProductComment::getByProduct((int) Tools::getValue('id_product'), 1, null, $this->context->cookie->id_customer),
       ));

        return $this->display(__FILE__, 'views/templates/hook/mproductcomments-extra.tpl');
    }
    ...
    public function hookProductTabContent($params)
    {
        ...
        $this->context->controller->addJS($this->_path.'js/mproductcomments.js');

        $id_guest = (!$id_customer = (int) $this->context->cookie->id_customer) ? (int) $this->context->cookie->id_guest : false;
        $customerComment = MProductComment::getByCustomer((int) (Tools::getValue('id_product')), (int) $this->context->cookie->id_customer, true, (int) $id_guest);

        $averages = MProductComment::getAveragesByProduct((int) Tools::getValue('id_product'), $this->context->language->id);
        $averageTotal = 0;
        ...
        $this->context->smarty->assign(array(
            ...
            'allow_guests' => (int) Configuration::get('M_PRODUCT_COMMENTS_ALLOW_GUESTS'),
            'too_early' => ($customerComment && (strtotime($customerComment['date_add']) + Configuration::get('M_PRODUCT_COMMENTS_MINIMAL_TIME')) > time()),
            'delay' => Configuration::get('M_PRODUCT_COMMENTS_MINIMAL_TIME'),
            'id_product_comment_form' => (int) Tools::getValue('id_product'),
            'secure_key' => $this->secure_key,
            ...
            'moderation_active' => (int) Configuration::get('M_PRODUCT_COMMENTS_MODERATE'),
            'isMobile' => $this->context->getMobileDevice(),
       ));

        $this->context->controller->pagination((int) MProductComment::getCommentNumber((int) Tools::getValue('id_product')));

        return $this->display(__FILE__, 'views/templates/front/mproductcomments.tpl');
    }
    ...
    public function hookHeader()
    {
        ...
        {
            $this->context->controller->addCSS($this->_path.'mproductcomments.css', 'all');
        }
    ...
    public function hookExtraProductComparison($params)
    {
        ...
        foreach ($params['list_ids_product'] as $id_product) {
            ...
            $grades = MProductComment::getAveragesByProduct($id_product, $this->context->language->id);
            $criterions = MProductCommentCriterion::getByProduct($id_product, $this->context->language->id);
            $grade_total = 0;
            if (count($grades) > 0) {
                ...
                $list_product_comment[$id_product] = MProductComment::getByProduct($id_product, 0, 3);
            }
        }
        ...
        return $this->display(__FILE__, 'views/templates/front/products-comparison.tpl');
    }
    ...
    public function initCategoriesAssociation($id_root = null, $id_criterion = 0)
    {
        ...
        if ($id_criterion == 0) {
            ...
            $pdc_object = new MProductCommentCriterion($id_criterion);
